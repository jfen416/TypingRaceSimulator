...
public class TypingRace
{
    ...
    public void startRace()
    {
        ...
        if (seat3Typist.getProgress() > winner.getProgress())
        {
            winner = seat3Typist;
        }
        ...
        // increase winner accuracy slightly at end of race
    ...
    private void advanceTypist(Typist theTypist)
    {
        ...
        //(J.F) Mistype backwards probability fix
        ...
        if (Math.random() < 0.05 * theTypist.getAccuracy() * theTypist.getAccuracy())
        {
            ...
            //(J.F) Burnout should sligthly decrease accuracy.
    ...
    private void printRace()
    {
        ...
        //(J.F) Null checks
        if (seat1Typist != null) printSeat(seat1Typist);
        System.out.println();

        if (seat2Typist != null) printSeat(seat2Typist);
        System.out.println();

        if (seat3Typist != null) printSeat(seat3Typist);
        System.out.println();
    ...
    private void printSeat(Typist theTypist)
    {
        ...
        //(J.F) Clamp it to force it to never go below 0.
        if (spacesAfter < 0)
        {
            spacesAfter = 0;
        }
        ...
        if (theTypist.isBurntOut())
        {
            ...
            //(J.F) Only decrement spaceAfter if it is greater than 0
            if (spacesAfter > 0)
            {
